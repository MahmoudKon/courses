                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="invalid-feedback">{{ $errors->all() ? $errors->first('password') : '' }}
                                </div>
                            </div>
                            ...
                            <div class="form-group has-feedback">
                                <input type="text" name="address" class="form-control"
                                    placeholder="@lang('site.address')" value="{{ $user->address }}">
                                <span class="glyphicon glyphicon-home form-control-feedback"></span>
                                <div class="invalid-feedback">{{ $errors->all() ? $errors->first('address') : '' }}
                                </div>
                            </div>
                            ...
                            <div class="form-group has-feedback">
                                <input type="date" name="birthday" class="form-control"
                                    placeholder="@lang('site.birthday')" style="line-height: 17px;"
                                    value="{{ $user->birthday }}">
                                <span class="glyphicon glyphicon-heart form-control-feedback"></span>
                                <div class="invalid-feedback">{{ $errors->all() ? $errors->first('birthday') : '' }}
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <div class="invalid-feedback">
                                    {{ $errors->all() ? $errors->first('password_confirmation') : '' }}</div>
                            </div>
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="single" {{ $user->status == 'single' ? 'selected' : '' }}>Single
                                    </option>
                                    <option value="in relation" {{ $user->status == 'in relation' ? 'selected' : '' }}>
                                        In Relation</option>
                                    <option value="married" {{ $user->status == 'married' ? 'selected' : '' }}>Married
                                    </option>
                                </select>
                    ...
                    <div class="form-group" id="permissions">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                ...
                                @endforeach
                                <div class="invalid-feedback">{{ $errors->all() ? $errors->first('permissions') : '' }}
                                </div>
