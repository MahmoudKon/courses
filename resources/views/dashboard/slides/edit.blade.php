    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form action="{{ route('dashboard.slides.update', $slider->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
        ...
        function loadRow(number)
        {
            var html = `<tr>
                            ...
                            <td width='10%'>
                                ...
                                <div class="form-group has-feedback">
                                    <label id="image">Image</label>
                                    <input type="file" name="image${count}[image]" class="form-control" placeholder="@lang('site.image')">
                                    <span class="glyphicon glyphicon-picture form-control-feedback"></span>
                                    <div class="invalid-feedback">{{ $errors->all() ? $errors->first('image') : '' }}</div>
                                </div>
                            </td>
