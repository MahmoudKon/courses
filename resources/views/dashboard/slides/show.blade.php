    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <a href="{{ route('dashboard.'.Request::segment('3').'.edit', $slide) }}" class="btn btn-info pull-right"> <i class="fa fa-edit"></i> @lang('site.edit')</a>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{ $slide->name }}" readonly>
            </div>
          </div>
        </div>
