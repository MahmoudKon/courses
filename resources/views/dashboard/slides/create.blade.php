            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.slides.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-feedback">
                        <label id="name">Slide Name</label>
            ...
            var html = `<tr>
                            <td>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" id="title" name="title[]" class="form-control" placeholder="@lang('site.title')">
                            ...
                            <td width='50%'>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="text" id="description" name="description[]" class="form-control" placeholder="@lang('site.description')">
                            ...
                            <td width='15%'>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="file" id="image" name="image[]" class="form-control" placeholder="@lang('site.image')">
