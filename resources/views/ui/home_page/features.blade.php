	        ...
	        <div class="row features_row">
	            ...
	            <div class="col-lg-3 feature_col">
	                <div class="feature text-center trans_400">
	                    <div class="feature_icon"><img src="{{ asset('ui/images/icon_1.png') }}" alt=""></div>
	            ...
	            <div class="col-lg-3 feature_col">
	                <div class="feature text-center trans_400">
	                    <div class="feature_icon"><img src="{{ asset('ui/images/icon_2.png') }}" alt=""></div>
	            ...
	            <div class="col-lg-3 feature_col">
	                <div class="feature text-center trans_400">
	                    <div class="feature_icon"><img src="{{ asset('ui/images/icon_3.png') }}" alt=""></div>
	            ...
	            <div class="col-lg-3 feature_col">
	                <div class="feature text-center trans_400">
	                    <div class="feature_icon"><img src="{{ asset('ui/images/icon_4.png') }}" alt=""></div>
